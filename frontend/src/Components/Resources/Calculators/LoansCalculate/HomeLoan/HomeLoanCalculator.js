...
const HomeLoanCalculator = () => {
  ...
  const calculateEMI = () => {
    ...
    // Scale the loan amount by 10 for correct output
    ...
    // Calculate EMI using standard formula with scaled amount
  ...
  const formatCurrency = (amount) => {
    ...
    let [wholePart, decimalPart] = num.split('.');
    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      <div className="container mx-auto">
        <div className="mb-4 pt-36">
          <h1 className="text-2xl font-bold text-gray-900">Home Loan EMI Calculator</h1>
          <p className="text-sm text-gray-600 mt-1">Calculate how much monthly you need to pay for your dream home</p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-3">
            <div className="grid grid-cols-2 gap-6">
              <InputField 
                ...
                unit="₹"
                step={50000}
                helpText="What is the your home loan amount today?"
              />
              <InputField 
                label="Home Loan Tenure" 
                value={values.loanTenure}
                onChange={v => handleChange('loanTenure', v)}
                min={1}
                max={30}
                unit="years"
                helpText="What is the tenure of the home loan?"
              />
              <InputField 
                ...
                unit="%"
                step={0.1}
                helpText="What is the rate of interest on the home loan?"
              />
              <InputField 
                ...
                max={30}
                unit="years"
                helpText="How many years of home loan repayment have you made?"
              />
            </div>
          </div>
