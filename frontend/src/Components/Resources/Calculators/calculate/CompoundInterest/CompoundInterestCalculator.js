...
const CompoundInterestCalculator = () => {
  ...
  useEffect(() => {
    const { maturity, interest } = calculateCompoundInterest();
  ...
  return (
    <div className="w-full bg-white py-12">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-20">
        ...
        <p className="text-gray-600 mt-2">Calculate compound interest on a loan or investment</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div>
              <div className="mb-2">
                ...
                <p className="text-sm text-gray-600 mt-1">Interest rate on your investment</p>
              </div>
              <div className="relative mt-6">
                <input
                  type="range"
