...
const DreamWeddingCalculator = () => {
  const [values, setValues] = useState({
    weddingCost: 500000, // Changed from 5000000 to 500000
    yearsToWedding: 3,
    expectedReturns: 12,
    expectedInflation: 6,
    showSavings: false,
  ...
  const [result, setResult] = useState(calculateWeddingFund());

  useEffect(() => {
    setResult(calculateWeddingFund());
  }, [values]);
    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      <div className="container mx-auto">
        <div className="mb-4 pt-36">
          <h1 className="text-2xl font-bold text-gray-900">Dream Wedding Calculator</h1>
          <p className="text-sm text-gray-600 mt-1">Calculate to start investing for your biggest day.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-[#113262] text-white p-4 rounded-lg">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-bold">Dream Wedding</h3>
