...
const FAQComponent = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Monthly performance review with quarterly rebalancing if needed"
    },
    {
      question: "What is the investment horizon?",
      answer: "Recommended 3-5 years or longer"
    }
  ];

  const importantNotes = [
    "All investments are subject to market risks",
    "Regular monitoring and rebalancing of portfolio",
