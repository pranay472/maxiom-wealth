        ...
        <div className="pt-32 pb-16 flex flex-col lg:flex-row items-center">
          ...
          <div className="w-full lg:w-1/2 text-white space-y-8">
            ...
            <p className="text-[#E8EEF6] leading-relaxed animate-fadeIn opacity-0" style={{ animationDelay: '0.6s' }}>
              Our expert team discovers and invests in high-potential small-cap companies, focusing on those poised for exceptional growth. With a proven track record and strategic approach, we help you capitalize on opportunities in the dynamic small-cap market segment.
            </p>
            
            <div className="flex flex-col gap-6 animate-fadeIn opacity-0" style={{ animationDelay: '0.9s' }}>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                  <div className="text-2xl font-bold text-[#F49611]">22.11%</div>
                  <div className="text-sm text-white/90">Current Returns</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                  <div className="text-2xl font-bold text-[#F49611]">23.69%</div>
