    ...
    <div className="py-24 space-y-32">
      ...
      <div className="max-w-7xl mx-auto px-4">
        <SectionTitle
          ...
          title="Our Unique Approach to Post Retirement Planning"
        />
          ...
          {[
            {
              ...
              description: "We bring our vast expertise in stocks and mutual funds into retirement solutions"
            },
            {
              icon: Laptop,
              title: "Integrated Planning",
              description: "Use our tech synergy to plan, execute, and monitor your retirement finances."
            },
            {
              icon: Award,
              title: "Certified Excellence",
              description: "Our ISO 9001 certified processes guarantee top-notch retirement planning services."
            },
            {
              icon: Shield,
              title: "Fiduciary Commitment",
              description: "Registered with SEBI, our guidance is always in your best interest."
            },
            {
              icon: Target,
              title: "Holistic Planning",
              description: "From assets to goals, every element is integrated into your retirement plan."
            },
            {
              icon: Brain,
              title: "Unbiased Recommendations",
              description: "We use data analytics to provide objective retirement planning advice."
            }
          ].map((approach, index) => (
            <ApproachCard
              key={index}
      ...
      <div className="relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24">
          <SectionTitle
            ...
            title="Benefits of Our Retirement Planning"
            align="center"
          />
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                icon: Shield,
                title: "Guaranteed Peace",
                description: "Relax with the assurance of tailored post-retirement income strategies working for you."
              },
              {
                icon: Lock,
                title: "Wealth Security",
                description: "Wealth preservation in retirement ensures a stress-free post-retirement phase."
              },
              {
                icon: Scroll,
                title: "Legacy Assured",
                description: "Our estate planning ensures a seamless transition of your assets."
              },
              {
                icon: UserCheck,
                title: "Expertise at Hand",
                description: "Our post-retirement advisors bring a wealth of knowledge to tailor the best strategies."
              }
            ].map((benefit, index) => (
              <BenefitCard
                key={index}
