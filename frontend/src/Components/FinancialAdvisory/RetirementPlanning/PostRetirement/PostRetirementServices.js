      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="grid grid-cols-2 gap-4">
            <StatisticCard value="1000+" label="Happy Retirees" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <FeatureCard
            ...
            description="Designing tailored post-retirement income strategies that suit your unique needs."
            isLarge={true}
          />
          ...
          <FeatureCard
            icon={ShieldCheck}
            title="Wealth Safeguard"
            description="Prioritising wealth preservation in retirement, so your finances remain intact."
          />
          
          <FeatureCard
            icon={ScrollText}
            title="Estate Structuring"
            description="Comprehensive estate planning for retirees ensures your legacy is secured."
          />
          
          <FeatureCard
            icon={Users}
            title="Expert Consultation"
            description="Avail the insights and expertise of our post-retirement advisors for holistic planning."
          />
        </div>
      </div>
    </div>
...
export default PostRetirementServices;