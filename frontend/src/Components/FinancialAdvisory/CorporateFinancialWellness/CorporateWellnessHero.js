        ...
        <div className="grid md:grid-cols-2 gap-12 items-center pt-12">
          ...
          <div>
            <div className="mb-8">
              ...
              <p className="text-xl text-white/80">
                Elevate your workforce's financial well-being with our comprehensive corporate solutions. 
                Enhance productivity through expert financial education and personalized guidance.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FeatureCard 
              ...
              description="Empower employees with knowledge for better financial choices"
            />
            <FeatureCard 
              Icon={Users}
              title="Enhanced Retention"
              description="Build loyalty through meaningful financial wellness programs"
            />
            <FeatureCard 
              Icon={TrendingUp}
              title="Increased Productivity"
              description="Reduce financial stress for improved workplace performance"
            />
            <FeatureCard 
              Icon={Shield}
              title="Custom Solutions"
              description="Tailored programs meeting your workforce's unique needs"
            />
          </div>
        </div>
      </div>
...
export default CorporateWellnessHero;