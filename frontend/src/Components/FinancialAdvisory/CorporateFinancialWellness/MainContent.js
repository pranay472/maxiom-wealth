    ...
    <div className="py-24 space-y-32">
      ...
      <div className="max-w-7xl mx-auto px-4">
        <SectionTitle
          ...
          title="How Our Corporate Approach Helps"
        />
          ...
          {[
            {
              ...
              description: "Deep expertise in stocks and mutual funds ensures accurate advice for your employees"
            },
            {
              icon: Laptop,
              title: "Integrated Technology",
              description: "Our mobile and web app seamlessly integrate all financial planning steps"
            },
            {
              icon: Shield,
              title: "Quality Assured",
              description: "ISO 9001 certified processes guarantee the best financial planning services"
            },
            {
              icon: Award,
              title: "Trusted Fiduciary",
              description: "Being SEBI registered, we prioritize your business's and employees' interests"
            }
          ].map((approach, index) => (
            <ApproachCard
              key={index}
      ...
      <div className="relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24">
          <SectionTitle
            ...
            title="Benefits of Corporate Financial Wellness"
            align="center"
          />
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                icon: Users,
                title: "Holistic Employee Growth",
                description: "Foster both professional and personal development through comprehensive financial guidance"
              },
              {
                icon: Building,
                title: "Company Reputation Boost",
                description: "Enhance your employer brand by demonstrating commitment to employee well-being"
              },
              {
                icon: Target,
                title: "Customized Solutions",
                description: "Tailored programs that address your specific workforce's unique financial needs"
              },
              {
                icon: Clock,
                title: "Higher Retention Rates",
                description: "Improve employee loyalty and reduce turnover through meaningful financial support"
              }
            ].map((benefit, index) => (
              <BenefitCard
                key={index}
