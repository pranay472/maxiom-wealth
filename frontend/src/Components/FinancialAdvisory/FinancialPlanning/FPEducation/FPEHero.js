          ...
          <div>
            <div className="mb-8">
              ...
              <p className="text-xl text-white/80">
                Equip yourself with the essential skills and knowledge to make informed financial decisions. Our educational resources cover everything from budgeting basics to advanced investment strategies.
              </p>
            </div>
