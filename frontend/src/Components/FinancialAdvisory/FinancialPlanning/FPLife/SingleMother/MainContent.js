          ...
          {[
            {
              ...
              description: "With profound knowledge in stocks and mutual funds, we provide apt investment strategies."
            },
            {
              icon: Smartphone,
              title: "Integrated Planning",
              description: "Our mobile and web app makes financial planning to execution a breeze."
            },
            {
              icon: Award,
              title: "Certified Excellence",
              description: "ISO 9001 certified, we promise top-notch financial and investment planning."
            },
            {
              icon: ShieldCheck,
              title: "SEBI Registered",
              description: "Our fiduciary role ensures that we always prioritise single mothers' interests."
            },
            {
              icon: Target,
              title: "Goal-Driven Plans",
              description: "All assets and investments are linked to specific future goals for the mother and child."
            },
            {
              icon: LineChart,
              title: "Objective Recommendations",
              description: "We use proprietary data analytics, ensuring unbiased advice."
            }
          ].map((approach, index) => (
            <ApproachCard
              key={index}
      ...
      <div className="relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24">
          <SectionTitle
            ...
            title="Financial Benefits Tailored for Single Mothers"
            align="center"
          />
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                ...
                description: "Harness tax-efficient strategies crafted for single mothers and boost your savings significantly."
              },
              {
                icon: ShieldCheck,
                title: "Reliable Expertise",
                description: "Benefit from our profound understanding, especially beneficial for single mother households."
              },
              {
                icon: Target,
                title: "Tailored Financial Solutions",
                description: "Financial strategies moulded to the unique needs of single mothers."
              },
              {
                icon: DollarSign,
                title: "Future Assured",
                description: "With our guidance, ensure a promising and comfortable future for both mother and child."
              }
            ].map((benefit, index) => (
              <BenefitCard
                key={index}
