      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center pt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FeatureCard 
              Icon={Globe}
              title="Asset Integration Advisory"
              description="Seamlessly integrate your global assets into the Indian financial ecosystem."
            />
            <FeatureCard 
              Icon={FileText}
              title="Taxation Reorientation"
              description="Expert advice to navigate through the unique taxation challenges for repatriates."
            />
            <FeatureCard 
              Icon={Calculator}
              title="Investment Restructuring"
              description="Align your global investments with the Indian market for optimised returns."
            />
            <FeatureCard 
              Icon={ShieldCheck}
              title="Insurance Reassessment"
              description="Review and adapt to the most suitable insurance plans"
            />
          </div>
        </div>
      </div>
