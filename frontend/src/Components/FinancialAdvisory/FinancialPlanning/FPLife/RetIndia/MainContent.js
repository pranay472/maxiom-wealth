      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            {
              icon: TrendingUp,
              title: "Local and Global Vision",
              description: "Deep expertise in stocks and mutual funds assures a balanced financial integration."
            },
            {
              icon: Smartphone,
              title: "Unified Digital Solutions",
              description: "Our platform connects every aspect of repatriate financial planning, catering specifically to your needs."
            },
            {
              icon: Award,
              title: "ISO Assured Processes",
              description: "Our certified methodologies guarantee premier financial restructuring for your return."
            },
            {
              icon: ShieldCheck,
              title: "Dedicated Fiduciary Role",
              description: "Registered with SEBI, our advisory always places your financial interests at the forefront."
            },
            {
              icon: Target,
              title: "Holistic Financial Mapping",
              description: "Tailored plans that map your global assets to your goals upon returning."
            },
            {
              icon: LineChart,
              title: "Unbiased Data-Driven Insights",
              description: "Proprietary analytics offer neutral, tailored advice for a smooth financial transition."
            }
          ].map((approach, index) => (
            <ApproachCard
              key={index}
      ...
      <div className="relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24">
          <SectionTitle
            ...
            title="Repatriate Financial Planning Benefits"
            align="center"
          />
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                icon: BarChart3,
                title: "Streamlined Asset Transition",
                description: "Hassle-free integration of overseas assets with Indian investments."
              },
              {
                icon: ShieldCheck,
                title: "Taxation Clarity",
                description: "Demystify the complex realm of repatriate taxation with expertise."
              },
              {
                icon: Target,
                title: "Effective Currency Management",
                description: "Protect and maximize your finances against currency volatilities during repatriation."
              },
              {
                icon: DollarSign,
                title: "Renewed Financial Security",
                description: "Resettle with a fortified financial foundation, tailored for your Indian return."
              }
            ].map((benefit, index) => (
              <BenefitCard
                key={index}
