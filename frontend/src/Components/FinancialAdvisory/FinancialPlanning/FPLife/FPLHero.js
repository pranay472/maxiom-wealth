          ...
          <div>
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Elevate Your Financial Strategy with Expert Insights
              </h1>
              <p className="text-xl text-white/80">
                Tailored financial solutions designed for professionals. Enhance your financial acumen with our expert guidance on investment strategies, tax planning, and wealth management.
              </p>
            </div>
