        ...
        <div className="grid md:grid-cols-2 gap-12 items-center pt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FeatureCard 
              ...
              description="Custom-built portfolios that align with your unique requirements. Watch your wealth grow with our astute strategies."
            />
            <FeatureCard 
              Icon={LineChart}
              title="Investment Advisory"
              description="Dive into the world of investments with our expert guidance. Navigate the financial markets with confidence and clarity."
            />
            <FeatureCard 
              Icon={Calculator}
              title="Holistic Financial Planning"
              description="Craft a comprehensive roadmap for your financial future. Every aspect is considered, ensuring tailored strategies for individuals with disabilities."
            />
            <FeatureCard 
              Icon={ShieldCheck}
              title="Insurance Advisory"
              description="Discover insurance plans curated for special needs."
            />
          </div>
        </div>
      </div>
